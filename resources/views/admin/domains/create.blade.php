...
@section('breadcrumb')
    <x-breadcrumb
        title="{{ __('dashboard.sidebar.domain.new') }}"
        :items="[
            ['label' => __('dashboard.sidebar.domain.create')]
        ]"
    />
@endsection
...
@section('content_2')
    <div class="main-content">
        <div class="container">
            <h2 class="title">
                {{ __('dashboard.sidebar.domain.create') }}
            </h2>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-xs-12 mb-3">
                        <div class="form-group cover">
                            <label for="cover">{{ __('forms.domain.cover') }}</label>
                    ...
                    <div class="col-md-6 col-xs-12 my-3 switch-container">
                        <div class="form-check form-switch form-check-reverse">
                            ...
                            <label class="form-check-label" for="featured">
                                {{ __('forms.domain.featured.title') }}
                    ...
                    <div class="col-md-12 col-xs-12 mb-3">
                        <div class="form-group">
                            <label for="description">{{ __('forms.domain.description') }}</label>
                    ...
                    <div class="col-md-12 col-xs-12 my-5">
                        <div class="buttons">
                            <a href="{{ route('domains.index') }}" class="btn secondary">
                                {{ __('buttons.cancel') }}
                            </a>
