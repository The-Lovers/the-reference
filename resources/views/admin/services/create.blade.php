                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-floating">
                            <select class="form-select" id="is_active" name="is_active" required>
                                <option value="1" {{ old('is_active', '1') == '1' ? 'selected' : '' }}>{{ __('forms.service.status.active') }}</option>
                                <option value="0" {{ old('is_active') == '0' ? 'selected' : '' }}>{{ __('forms.service.status.inactive') }}</option>
                            </select>
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-floating">
                            <select class="form-select" id="is_featured" name="is_featured" required>
                                <option value="0" {{ old('is_featured', '0') == '0' ? 'selected' : '' }}>{{ __('forms.service.featured.no') }}</option>
                                <option value="1" {{ old('is_featured') == '1' ? 'selected' : '' }}>{{ __('forms.service.featured.yes') }}</option>
                            </select>
